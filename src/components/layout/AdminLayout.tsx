          ...
          <div className="flex items-center justify-between px-4 lg:px-6 py-4">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="lg:hidden p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 transition-colors duration-200"
              >
                <Menu className="w-5 h-5" />
              </button>
              <h1 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-white transition-colors duration-200 truncate">
                TerraPrice Admin
              </h1>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block text-right">
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-200 truncate">
